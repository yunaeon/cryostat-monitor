...
#returns the temperature or raises an exception
	...
	PortList.insert(0,Guess)
      ...
      for Port in PortList:			
	    ...
	    try:
			port = serial.Serial( port=Port,baudrate=9600, bytesize=7, parity='O', stopbits=1)
	    except OSError as e:
...
def SendTexts(TxString):
      ...
      try:
	    ...
	    server.login('gripsssl@gmail.com','grip$557')
					#server.login('gripsssl@gmail.com','grips557')
...
def LogText(String):
      ...
      with open("/home/grips/monitor_code/textlog.dat","a") as f:
...
def GrabLastLakeshoreTemp():
      ...
      output = sp.check_output(['tail','/home/grips/monitor_code/log.dat'])
...
def RsyncText(String):
	...
	try:
		...
		Timestamp = time.strftime("%B %d %Y %H:%M:%S -- ",time.localtime())
		f = open("/home/grips/monitor_code/last_update.dat","w")
		f.write(Timestamp+String+'\n')
		f.close()

		sp.call(['rsync','/home/grips/monitor_code/textlog.dat','brentm@apollo.ssl.berkeley.edu:/home/brentm/public_html'])
		sp.call(['rsync','/home/grips/monitor_code/last_update.dat','brentm@apollo.ssl.berkeley.edu:/home/brentm/public_html'])
